...
console.log(`O pote de marmita da Myllene é ${poteDeMarmita.cor}, possui um formato ${poteDeMarmita.formato}, tem ${poteDeMarmita.reparticoesInternas} repartições internas e possui talheres (${poteDeMarmita.talheres}).`);
